export const Extras = {
  ...
  treasure_recoverlostcard: {
    text: 'Treasure: Recover a lost card',
  },
  treasure_heal5hitpoints: {
    text: 'Treasure: Heal 5 hitpoints',
  },
  treasure_5gold: {
    text: 'Treasure: 5 gold',
  },
  treasure_10gold: {
    text: 'Treasure: 10 gold',
  },
  treasure_refresh_2_smallitems: {
